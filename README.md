...
- Нагрузочное тестирование — определение и проверка характеристик производительности системы.
- Тестирование базы данных — проверка функционирования внешней базы данных и хранимых процедур.
...
Проект небольшой, поэтому не требует большой команды, достаточно одного QA -инженера и разработчика.
